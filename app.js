...
*/
const numItems = brazilianFoods.length;
const foodsInfo = `Até aqui, o array "brazilianFoods" possui ${numItems} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]} e ${brazilianFoods[2]}.`;
